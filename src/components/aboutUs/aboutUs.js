...
import redeye from '../../../assets/images/redeye.jpg';
  ...
  return(
    <div className="aboutUs">
      ...
      <div className="aboutUs__pContainer">
        ...
        <p className="aboutUs__p">
          <img src={pelRelease} alt="baby opossum" className="aboutUs__pelRelease"/>
        ...
        <p className="aboutUs__p">
          <img src={redeye} alt="black bird" className="aboutUs__redeye"/>
